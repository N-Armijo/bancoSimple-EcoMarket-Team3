INSERT INTO Country (iso, name, nationality) VALUES
                                                 ('CL', 'Chile', 'Chilena'),
...
INSERT INTO Region (name, region_country) VALUES
                                              ('Metropolitana', 1),
                                              ('Valparaíso', 1),
                                              ('Biobío', 1),
                                              ('Buenos Aires', 2),
...
INSERT INTO Commune (name, zip_code, commune_region) VALUES
                                                         ('Santiago', '8320000', 1),
...
INSERT INTO User (name, email, password, birthday, registration_date, phone_number, user_country) VALUES
...
INSERT INTO user_role (user_id, rol_id) VALUES
                                            (1, 1),  -- Juan es ADMIN
                                            (2, 2),  -- María es USER
                                            (2, 3),  -- María también es SELLER
                                            (3, 2),  -- Carlos es USER
                                            (4, 4),  -- Ana es MANAGER
                                            (5, 2);  -- Pedro es USER


INSERT INTO Bank_account (account_number, balance, bank_user) VALUES
...
INSERT INTO Be_pass (password, pass_account) VALUES
                                                 ('secret123', 1),
                                                 ('secure456', 2),
                                                 ('private789', 3),
                                                 ('hidden012', 4),
...
INSERT INTO Bank_card (card_number, expiration_date, creation_date, secret_number, card_account) VALUES
...
INSERT INTO Direction (alias, street, number, department, home, creation_date, direction_user, direction_commune) VALUES
...
INSERT INTO Product (product_name, description, price, stock, product_User) VALUES
...
INSERT INTO Order_product (direction_alias, dateP, total, state, order_User, order_Account) VALUES
...
INSERT INTO Detail_Order (ammount, unit_price, detail_product, detail_order) VALUES
                                                                                 (1, 599990, 1, 1),
                                                                                 (1, 29990, 2, 2),
                                                                                 (2, 599990, 1, 3),
                                                                                 (3, 24990, 4, 4),
...
INSERT INTO Transaction (amount, type, date, description, state, transaction_Origin, transaction_Destiny) VALUES
...
INSERT INTO Desc_ticket (name, description, table_reference) VALUES
...
INSERT INTO Audit_ticket (action, affected_record, details, date, ip, audit_User, audit_Desc) VALUES
